"""
Django settings for binaryscript project.
...
SECRET_KEY = '0(310h)#xs28#w9we9=y85#&8av*(!ux5q*%ff#wrb#baa&9ij'
...
ROOT_URLCONF = 'binaryscript.urls'
...
WSGI_APPLICATION = 'binaryscript.wsgi.application'
...
STATIC_URL = '/static/'
from binaryscript.settings_local import *