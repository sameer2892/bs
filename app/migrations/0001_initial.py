    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('signoff_date', models.DateField(blank=True, editable=False)),
                ('name', models.CharField(max_length=200)),
                ...
                ('employee', models.ManyToManyField(blank=True, null=True, to='app.Employee')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField()),
                ('finish_date', models.DateField()),
                ('employee', models.ManyToManyField(to='app.Employee')),
            ],
            options={
                'abstract': False,
            },
